            ...
            tab_data_broker = {
                ...
                args = {
                    data_broker_space_1 = {
                        type = 'description',
                        name = '',
                        order = self:GetOptionOrder('data_broker'),
                    },
                    data_broker_show_item_name = {
                        type = 'toggle',
                    ...
                    data_broker_show_item_icon = {
                        type = 'toggle',
                        name = L['FARM_BUDDY_DATA_BROKER_SHOW_ITEM_ICON'],
                        get = function() return self:GetSetting('showDataBrokerItemIcon', 'bool') end,
                        set = function(_, input) self:SetSetting('showDataBrokerItemIcon', 'bool', input, true) end,
                        width = 'full',
                        order = self:GetOptionOrder('data_broker'),
                    },
                    data_broker_space_3 = {
                    ...
                    data_broker_show_item_name_color = {
                        type = 'toggle',
                        name = L['FARM_BUDDY_DATA_BROKER_SHOW_ITEM_NAME_COLOR'],
                        get = function() return self:GetSetting('showDataBrokerItemNameColor', 'bool') end,
                        set = function(_, input) self:SetSetting('showDataBrokerItemNameColor', 'bool', input, true) end,
                        width = 'full',
                        order = self:GetOptionOrder('data_broker'),
                    },
                    data_broker_space_4 = {
            ...
            tab_about = {
                ...
                args = {
                    ...
                    about_info_localization_enUS = {
                        type = 'description',
                        name = self:GetColoredText(L['FARM_BUDDY_ENGLISH'], FARM_BUDDY_COLOR_GREEN),
                        fontSize = 'medium',
                        order = self:GetOptionOrder('about'),
                        width = 'full',
                    },
                    ...
                    about_info_localization_ruRU = {
                        type = 'description',
                        name = self:GetColoredText(L['FARM_BUDDY_RUSSIAN'], FARM_BUDDY_COLOR_GREEN),
                        fontSize = 'medium',
                        order = self:GetOptionOrder('about'),
                        width = 'full',
                    },

local L = LibStub('AceLocale-3.0'):NewLocale('FarmBuddyStandalone', 'enUS', true) or {}
...
L["FARM_BUDDY_ALERT_COUNT_USAGE"] = "A quantity for your farming goal."
...
L["FARM_BUDDY_COMMAND_RESET_DESC"] = "Resets Farm Buddy to its default settings."
L["FARM_BUDDY_COMMAND_SETTINGS_DESC"] = "Open up the AddOn settings page."
L["FARM_BUDDY_COMMAND_TOGGLE_DESC"] = "Toggles the visibility of the main frame."
...
L["FARM_BUDDY_CONFIRM_RESET_FRAME_POSITION"] = "Are you sure you want to reset the main frame to its default position?"
...
L["FARM_BUDDY_FAST_TRACKING_SHORTCUTS_DESC"] = "Combine your desired keys as a fast tracking shortcut. Fast tracking allows you to track an item from your inventory with this shortcut."
...
L["FARM_BUDDY_INCLUDE_WARBAND_BANK"] = "Include items in your Warband Bank"
L["FARM_BUDDY_INCLUDE_WARBAND_BANK_DESC"] = "If enabled items in your Warband Bank are included when counting the farmed item."
...
L["FARM_BUDDY_LOCK_FRAME_DESC"] = "When this option is active the frame is locked at its place an can't be moved."
...
L["FARM_BUDDY_CHAT_NOTIFICATIONS"] = "Enable chat notifications"
L["FARM_BUDDY_CHAT_NOTIFICATIONS_DESC"] = "Shows a notification in the chat as soon as the set goal has been reached."
...
L["FARM_BUDDY_SOUND_ALARM_1"] = "Alarm Clock 1"
L["FARM_BUDDY_SOUND_ALARM_2"] = "Alarm Clock 2"
L["FARM_BUDDY_SOUND_ALARM_3"] = "Alarm Clock 3"
L["FARM_BUDDY_SOUND_READY_CHECK"] = "Ready Check"
L["FARM_BUDDY_SOUND_RAID_WARNING"] = "Raid Warning"
L["FARM_BUDDY_SOUND_AUCTION"] = "Auction House"
L["FARM_BUDDY_SOUND_QUEST_COMPLETE"] = "Quest Complete"
L["FARM_BUDDY_SOUND_DUNGEON_REWARD"] = "Dungeon Reward"
L["FARM_BUDDY_SOUND_EPIC_LOOT"] = "Epic Loot"
L["FARM_BUDDY_SOUND_LEGENDARY_LOOT"] = "Legendary Loot"
...
L["FARM_BUDDY_SHOW_ICON_DESC"] = "Sets whether the item's icon should be displayed."
...
L["FARM_BUDDY_DATA_BROKER_SHOW_ITEM_ICON"] = "Show item icon"
L["FARM_BUDDY_DATA_BROKER_SHOW_ITEM_NAME_COLOR"] = "Show item name color"
L["FARM_BUDDY_ITEM_CONTEXT_MENU_SET_GOAL"] = "Set goal"
L["FARM_BUDDY_ITEM_CONTEXT_MENU_HIDE"] = "Hide"
L["FARM_BUDDY_ITEM_CONTEXT_MENU_REMOVE"] = "Remove"
L["FARM_BUDDY_OK"] = "OK"
L["FARM_BUDDY_CANCEL"] = "Cancel"
L["FARM_BUDDY_POPUP_SET_GOAL_AMOUNT"] = "Set target amount for %s:"
L["FARM_BUDDY_CHAT_NOTIFICATION_TEXT"] = "The goal of !quantity! for !itemLink! has been reached!"
L["FARM_BUDDY_COMMAND_TEST_NOTIFICATION_DESC"] = "Triggers a test for the finish notification."
